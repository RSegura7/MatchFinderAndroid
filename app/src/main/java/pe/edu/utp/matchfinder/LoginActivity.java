...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "test@matchfinder.com:123456", "test_2@matchfinder.com:123456789"
    };
    /**
    ...
    private TextView forgottenText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgottenText = (TextView) findViewById(R.id.olvidar);
        forgottenText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent forgottenActivity = new Intent(LoginActivity.this,ForgotPasswordActivity.class);
    ...
    public void loguin(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "http://andre2sm.000webhostapp.com/Users/getLogin.php", new Response.Listener<String>() {
            @Override
